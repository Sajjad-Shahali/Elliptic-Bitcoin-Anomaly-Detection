...
\textbf{7} & \textbf{SAGE} & \textbf{3L h=256, lr=0.0038, 274 ep (Optuna)} & \textbf{0.690} & 0.901 & \textbf{0.706} \\
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{gnn_prog_left.png}\\[4pt]
  \includegraphics[width=\columnwidth]{gnn_prog_right.png}
