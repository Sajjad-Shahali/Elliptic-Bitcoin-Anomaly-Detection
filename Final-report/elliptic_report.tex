...
classification thresholds are selected by optimising F1 on a labeled
...
not be generalised beyond mean-aggregation architectures at this scale.
...
\textbf{Concept drift.}
Illicit rate drops 11.6\,\%$\to$6.5\,\% over 15 steps.  Production
systems need temporal threshold recalibration; practical strategies include
sliding-window F1 re-optimisation on the most recent labeled window,
...
different feature subsets---our GNN results represent a strong but not
...
across paradigms; direct comparison to reported Elliptic SOTA
